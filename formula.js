...
const FORMULA = {
  ...
  complexityLevels: [
    {
      value: "very-simple",
      label: "Very Simple - Single calc type, standard rules only",
      multiplier: 0.7,
    },
    {
      value: "simple",
      label: "Simple - 1-2 calc types, minor special factors",
      multiplier: 1.0,
    },
    {
      value: "moderate",
      label: "Moderate - Several calc types, some scheme complexity",
      multiplier: 1.3,
      default: true,
    },
    {
    ...
    {
      value: "very-complex",
      label: "Very Complex - Full calc suite, multiple interacting factors",
      multiplier: 2.2,
    },
  ],
  ...
  dataQualityLevels: [
    {
      value: "excellent",
      label: "Excellent - Fully validated, no known issues",
      multiplier: 0.8,
    },
    { value: "good", label: "Good - Clean, minor gaps", multiplier: 1.0 },
    {
      value: "average",
      label: "Average - Some gaps/issues",
      multiplier: 1.25,
      default: true,
    },
    ...
    {
      value: "very-poor",
      label: "Very Poor - Major remediation needed",
      multiplier: 2.0,
    },
  ],
  ...
  calcTypes: [
    ...
    { id: "deferredRetired", label: "Deferred to Retired", default: true },
